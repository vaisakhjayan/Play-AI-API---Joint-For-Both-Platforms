...
def get_chrome_profile_path():
    ...
    if get_platform() == 'Windows':
        return os.path.join(os.path.expanduser("~/Desktop"), "Chrome Profile 2")
    elif get_platform() == 'macOS':
        return "/Users/superman/Desktop/Chrome Profile (Joint API)"
    else:
        return os.path.join(os.path.expanduser("~/Desktop"), "Chrome Profile 2")
...
def get_celebrity_vo_path():
    ...
    """
    if get_platform() == 'Windows':
        return r"E:\Urbanoire Voice Overs"
    elif get_platform() == 'macOS':
        return os.path.join(os.path.expanduser("~/Desktop"), "Urbanoire Voiceovers")
    else:
        return os.path.join(os.path.expanduser("~/Desktop"), "Urbanoire Voiceovers")
