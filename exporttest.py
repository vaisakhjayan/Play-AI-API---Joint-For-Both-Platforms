...
chrome_options.add_experimental_option('prefs', {
    'download.default_directory': "E:\\Urbanoire Voice Overs",
...
user_data_dir = os.path.expanduser("~/Desktop/Chrome Profile 2")
...
try:
    ...
    url = "https://app.play.ht/studio/file/GOEv6Q1nqS6dhFaiMoHN"
